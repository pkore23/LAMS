...
public class LamsSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    public void onPerformSync(Account account, Bundle extras, String authority, ContentProviderClient provider, SyncResult syncResult) {
        ...
        try {
            ...
            final String APP_INTERFACE_STUDENT_URL =
                    "http://192.168.1.103/appinterface/get_student.php";
            ...
            ContentValues cv[] = new ContentValues[rows.length];
            int i=0;
            for (String row:rows) {
                ...
                cv[i].put(LamsDataContract.Student.COLUMN_MENTOR,columns[6]);
